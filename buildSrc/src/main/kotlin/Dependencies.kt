...
object Deps {
    ...
    val playOauthClientJetty by lazy { "com.google.oauth-client:google-oauth-client-jetty:${Versions.playOauthClientJetty}" }
    val playCalendar by lazy { "com.google.apis:google-api-services-calendar:${Versions.playCalendar}" }
    val googleClientAndroid by lazy { "com.google.api-client:google-api-client-android:${Versions.googleClientAndroid}" }
    val apacheComponent by lazy { "org.apache.httpcomponents" }

    val guava by lazy { "com.google.guava:listenablefuture:9999.0-empty-to-avoid-conflict-with-guava" }
    val easyPermission by lazy { "pub.devrel:easypermissions:${Versions.easyPermission}" }
...
object AppInfo {
    val applicationId by lazy { "com.beni.calendarscheduler" }
